...
#ggplot: libreria para manejar plots de forma más flexible
#theme: funcion para el diseño del plot
...
#Se esportan los valores de la segunda y tercera columna de la matriz a un archivo de extensión .txt
